...
namespace Kitaplik_Proje
{
    public partial class Form1 : Form
    {
        ...
        OleDbConnection baglanti = new OleDbConnection(@"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Users\user\OneDrive\Masaüstü\Kitaplik.mdb");
        ...
        private void BtnKaydet_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Close();
            MessageBox.Show("Kitap Listesi Kaydedildi", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Information);
            listele();
        }
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Close();
            MessageBox.Show("Kitap Listesi Güncellendi", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Information);
            listele();
        }
